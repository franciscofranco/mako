...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	//{ 0, {   486000, HFPLL, 2, 0x24 }, L2(5),   975000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),  1000000 },
	//{ 0, {   594000, HFPLL, 1, 0x16 }, L2(5),  1000000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	//{ 0, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),   950000 },
	//{ 0, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	//{ 0, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
